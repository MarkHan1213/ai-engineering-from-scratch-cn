      ...
      '<div class="cp-panel">' +
        ...
        '<div class="cp-footer">' +
          '<span class="cp-footer-group">' +
            '<kbd>↑</kbd><kbd>↓</kbd>' +
            '<span class="cp-footer-label">移动</span>' +
          '</span>' +
          '<span class="cp-footer-group">' +
            '<kbd>↵</kbd>' +
  ...
  function renderResults(results) {
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      if (r.kind === 'lesson') {
        ...
        dest = r.lessonPath
          ? 'lesson.html?path=' + encodeURIComponent(r.lessonPath)
          : ('https://github.com/MarkHan1213/ai-engineering-from-scratch-cn/tree/main/' + r.file);
